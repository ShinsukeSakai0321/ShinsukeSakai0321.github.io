...
f(x)=log(log(1/(1-x)))
set ytics ("0.01" f(0.0001),"0.1" f(0.001),"1" f(0.01),"5" f(0.05),\
          "10" f(0.1),"20" f(0.2),"30" f(0.3),\
          "40" f(0.4),"50" f(0.5),"60" f(0.6),\
          "70" f(0.7),"80" f(0.8),"90" f(0.9),\
          "95" f(0.95),"99" f(0.99),"99.9"f(0.999),"99.99" f(0.9999))
set yrange [f(0.0001):f(0.9999)]
set y2range [f(0.0001):f(0.9999)]
set x2range [log(0.1):log(100)]
set x2tics 1
set y2tics 1
set ytics nomirror
set xtics nomirror
set xrange [0.1:100.0]
set ylabel "Cumulative probability F(x)(%)"
set x2label "ln(x)"
set y2label "ln(ln(1/(1-F)))"
set xlabel "x"
set logscale x
set grid
set grid xtics ytics mxtics mytics
plot 0 notitle w l,"weibull-mean.txt" using 1:(f($2)) notitle w lp
#    EOF
