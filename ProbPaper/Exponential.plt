...
f(x)=log(1/(1-x))
set ytics ("1" f(0.01),"5" f(0.05),\
          "10" f(0.1),"20" f(0.2),"30" f(0.3),\
          "40" f(0.4),"50" f(0.5),"60" f(0.6),\
          "70" f(0.7),"80" f(0.8),"90" f(0.9),\
          "95" f(0.95),"99" f(0.99),"99.9"f(0.999))
set yrange [f(0.01):f(0.999)]
set y2range [f(0.01):f(0.999)]
set y2tics 1
set ytics nomirror
set ylabel "F(x)(%)"
set xlabel "x"
set y2label "ln(1/(1-F))"
set grid
set grid xtics ytics mxtics mytics
plot "Exponential-mean.txt" using 1:(f($2)) notitle w lp
#    EOF
