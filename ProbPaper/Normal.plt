...
set xtics 1
set ytics ("0.01" invnorm(0.0001),"0.1" invnorm(0.001),"1" invnorm(0.01),"5" invnorm(0.05),\
          ...
          "95" invnorm(0.95),"99" invnorm(0.99),"99.9" invnorm(0.999),"99.99" invnorm(0.9999))
set yrange [invnorm(0.0001):invnorm(0.9999)]
set ylabel "Cumulative probability F(x)(%)"
set xlabel "x"
set grid
plot invnorm(0.8417) notitle w l,invnorm(0.5) notitle w l,invnorm(0.1587) notitle w l,"normal-mean.txt" using 1:(invnorm($2)) ti "Mean rank" w lp,\
"normal-median.txt" using 1:(invnorm($2)) ti "Median rank" w lp
#    EOF
